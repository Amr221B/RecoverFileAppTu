...
public class Base64 {
    ...
    private static int b4Posn2;
    private static int outBuff;
...
//        (int) ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED
        byte[] outBuff = encode(source, off, len, alphabet, 0);
